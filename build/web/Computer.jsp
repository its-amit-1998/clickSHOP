                    ...
                    <tr valign="top">
                        <td class="part-1">
                            <div class="filter">
                                <ul type="none">
                                    ...
                                    <a href="Computer.jsp"><li><input type="checkbox" name="Bag" checked>
                        ...
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="col-md-12  single-item noPadding">
                                        <div class="top"><a href="Product Details-8.jsp"><img src="printer.jpg"></a></div>
                                        <div class="bottom">
                                            <h3 class="item-title" style="text-align: center;"><a href="Product Details-8.jsp">Canon Printer</a></h3>
                                            <div class="pull-right cutted-price text-muted"><del>&#8377; 3499</del></div>
                                            <div class="clearfix"></div>
                                            <div class="pull-right discounted-price">&#8377; 2999</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
