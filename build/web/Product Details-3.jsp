                ...
                <table>
                    <tr>
                        <td id="details-of-product">
                    		...
                    		<h3>Details of MAGGI 2-Minute Instant Noodles, Masala - 840g (Pack of 12 x 70g Each)</h3><hr><br>
                    		<form action="Product_details.jsp" method="post">  
                            		...
                            		<table id="inner-table">
                                            <caption>Details of Maggi</caption>
                                            <tr>
                                                <td id="rows">Name</td>
                                    		<td id="rows">
                                                    <label for="name">Maggi</label>
                                                    <input type="text" name="name" value="Maggi" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="white-rows">Company</td>
                                    		<td id="white-rows">Nestle</td>
                                            </tr>
                                            <tr>
                                    		<td id="rows">Type</td>
                                    		...
                                    		<td id="white-rows">
                                                    <label for="price">&#8377; 120</label>
                                                    <input type="text" name="price" value="120" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td id="textarea" colspan="2" rows="5" cols="50" style="word-wrap: break-word; padding-bottom: 4%;">Description: maggi2-Minute Masala Noodles is an instant noodles brand manufactured by Nestle. Made with the finest quality spices and ingredients. Each portion (70g) provides 15% of your daily Iron requirement*. Ready in 2 minutes, perfect meal for a hang out or house party.</td>
                                            </tr>
                            		</table>
                                    </div>
                                    <div style="clear: both;"></div>
