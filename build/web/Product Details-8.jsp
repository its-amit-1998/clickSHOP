                ...
                <table>
                    <tr>
                        <td id="details-of-product">
                    		...
                    		<h3>Details of Canon PIXMA MG2577s All-in-One Inkjet Colour Printer (Blue/White)</h3><hr><br>
                    		<form action="Product_details.jsp" method="post">  
                            		...
                            		<table id="inner-table">
                                            <caption>Details of Canon printer</caption>
                                            <tr>
                                                <td id="rows">Name</td>
                                    		<td id="rows">
                                                    <label for="name">Canon printer</label>
                                                    <input type="text" name="name" value="Canon printer" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="white-rows">Company</td>
                                    		<td id="white-rows">Canon Inc.</td>
                                            </tr>
                                            <tr>
                                    		<td id="rows">Type</td>
                                    		<td id="rows"></td>
                                    		...
                                    		<td id="white-rows">
                                                    <label for="price">&#8377; 2999</label>
                                                    <input type="text" name="price" value="2999" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td id="textarea" colspan="2" rows="5" cols="50" style="word-wrap: break-word; padding-bottom: 4%;">Description: Printer Type - Inkjet; Functionality - All-in-One (Print, Scan, Copy); Printer Output - Color. Connectivity-USB; Compatibility:Windows 8 / Windows 7 / Window Vista / Windows XP, Mac OS X v10.7.5 and later. Auto Power On. No LCD diplay on printer.</td>
                                            </tr>
                            		</table>
                                    </div>
                                    <div style="clear: both;"></div>
