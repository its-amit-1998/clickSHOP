                        ...
                        <td class="part-1">
                            <div class="filter">
                                <ul type="none">
                                    ...
                                    <a href="Books.jsp"><li><input type="checkbox" name="Bag" checked>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="col-md-12  single-item noPadding">
                                        <div class="top"><a href="Product Details-9.jsp"><img src="7habit.jpg"></a></div>
                                        <div class="bottom">
                                            <h3 class="item-title" style="text-align: center;"><a href="Product Details-9.jsp">7 Habits</a></h3>
                                            <div class="pull-right cutted-price text-muted"><del>&#8377; 433</del></div>
                                            <div class="clearfix"></div>
                                            <div class="pull-right discounted-price">&#8377; 400</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="col-md-12  single-item noPadding">
                                        <div class="top"><a href="Product Details-11.jsp"><img src="10rules.jpg"></a></div>
                                        <div class="bottom">
                                            <h3 class="item-title" style="text-align: center;"><a href="Product Details-11.jsp">10 Rules</a></h3>
                                            <div class="pull-right cutted-price text-muted"><del>&#8377; 269</del></div>
                                            <div class="clearfix"></div>
                                            <div class="pull-right discounted-price">&#8377; 239</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
