                ...
                <div class="table-container">
                    ...
                    %>
                                <tr>
                                    ...
                                    <td class="delete">
                                        <a href="Delete.jsp?id=<%=rs.getString("id") %>" onclick="delete();"><img src="basket.svg"></a>
                                    </td>
                                </tr>
                    <%
                                i++;
                    ...
                    <a href="Shipping Address.jsp"><input style="cursor: pointer;" type="submit"id="submit" value="Proceed to Checkout"></a>
                    <a href="AllProduct.jsp"><input style="cursor: pointer;" type="button" id="submit" value="Continue Shopping"></a>
                </div>  
            </div>
        </div>
        <footer>
