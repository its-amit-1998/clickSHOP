                ...
                <table>
                    ...
                    <tr valign="top">
                        <td class="part-1">
                            <div class="filter">
                                <ul type="none">
                                    <a href="Pantry.jsp"><li><input type="checkbox" name="Bag" checked>
                        ...
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="col-md-12  single-item noPadding">
                                        <div class="top"><a href="Product Details-2.jsp"><img src="scotch.jpg"></a></div>
                                        <div class="bottom">
                                            <h3 class="item-title" style="text-align: center;"><a href="Product Details-2.jsp">Scotch-Brite</a></h3>
                                            <div class="pull-right cutted-price text-muted"><del>&#8377; 105</del></div>
                                            <div class="clearfix"></div>
                                            <div class="pull-right discounted-price">&#8377; 80</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="col-md-12  single-item noPadding">
                                        <div class="top"><a href="Product Details-4.jsp"><img src="sunfeast.jpg"></a></div>
                                        <div class="bottom">
                                            <h3 class="item-title" style="text-align: center;"><a href="Product Details-4.jsp">Sunfeast</a></h3>
                                            <div class="pull-right cutted-price text-muted"><del>&#8377; 120</del></div>
                                            <div class="clearfix"></div>
                                            <div class="pull-right discounted-price">&#8377; 78</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
