                ...
                <table>
                    <tr>
                        <td id="details-of-product">
                    		...
                    		<h3>Details of the 10 Rules of Successful Nations Paperback</h3><hr><br>
                    		<form action="Product_details.jsp" method="post">  
                            		...
                            		<table id="inner-table">
                                            ...
                                            <tr>
                                                <td id="rows">Name</td>
                                    		<td id="rows">
                                                    <label for="name">10 Rules of Successful Nations</label>
                                                    <input type="text" name="name" value="10 Rules of Successful Nations" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                    		<td id="rows">Type</td>
                                    		...
                                    		<td id="white-rows">
                                                    <label for="price">&#8377; 239</label>
                                                    <input type="text" name="price" value="239" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
