                ...
                <table>
                    <tr>
                        <td id="details-of-product">
                    		...
                    		<h3>Details of Sunfeast Dark Fantasy Choco Fills, 300g</h3><hr><br>
                    		<form action="Product_details.jsp" method="post">  
                                    <div id="product-image">
                            		<img src="sunfeast.jpg">
                                    </div>
                                    <div id="product-details">
                            		<table id="inner-table">
                                            <caption>Details of Sunfeast</caption>
                                            <tr>
                                                <td id="rows">Name</td>
                                    		<td id="rows">
                                                    <label for="name">Sunfeast</label>
                                                    <input type="text" name="name" value="Sunfeast" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="white-rows">Company</td>
                                    		<td id="white-rows">ITC</td>
                                            </tr>
                                            <tr>
                                    		<td id="rows">Type</td>
                                    		...
                                    		<td id="white-rows">
                                                    <label for="price">&#8377; 78</label>
                                                    <input type="text" name="price" value="78" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td id="textarea" colspan="2" rows="5" cols="50" style="word-wrap: break-word; padding-bottom: 4%;">Description: An exquisite combination of luscious chocolate filling enrobed within a perfectly baked rich cookie outer. An offer that fully epitomizes the brand promise of pure indulgence.</td>
                                            </tr>
                            		</table>
                                    </div>
                                    <div style="clear: both;"></div>
