                ...
                <table>
                    <tr>
                        <td id="details-of-product">
                    		...
                    		<h3>Details of HP 10th Gen Intel Core i3 15.6-inch Laptop</h3><hr><br>
                    		<form action="Product_details.jsp" method="post">  
                            		...
                            		<table id="inner-table">
                                            <caption>Details of HP Laptop</caption>
                                            <tr>
                                                <td id="rows">Name</td>
                                    		<td id="rows">
                                                    <label for="name">HP Laptop</label>
                                                    <input type="text" name="name" value="HP Laptop" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="white-rows">Company</td>
                                    		<td id="white-rows">hp</td>
                                            </tr>
                                            <tr>
                                    		<td id="rows">Type</td>
                                    		<td id="rows"></td>
                                    		...
                                    		<td id="white-rows">
                                                    <label for="price">&#8377; 39990</label>
                                                    <input type="text" name="price" value="39990" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td id="textarea" colspan="2" rows="5" cols="50" style="word-wrap: break-word; padding-bottom: 4%;">Description: 1.2GHz Intel Core i3-1005G1 10th Gen processor. 4GB DDR4 RAM; 512 GB SSD. Windows 10 Home operating system; Microsoft Office 2019 - Home and Student edition. 15.6-inch screen, Intel UHD Graphics Graphics. 1.77kg laptop. </td>
                                            </tr>
                            		</table>
                                    </div>
                                    <div style="clear: both;"></div>
