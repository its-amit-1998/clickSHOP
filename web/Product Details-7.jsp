                ...
                <table>
                    <tr>
                        <td id="details-of-product">
                    		...
                    		<h3>Details of SanDisk Cruzer Blade 32GB USB Flash Drive</h3><hr><br>
                    		<form action="Product_details.jsp" method="post">  
                            		...
                            		<table id="inner-table">
                                            <caption>Details of SanDisk pen drive</caption>
                                            <tr>
                                                <td id="rows">Name</td>
                                    		<td id="rows">
                                                    <label for="name">SanDisk pen drive</label>
                                                    <input type="text" name="name" value="SanDisk pen drive" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="white-rows">Company</td>
                                    		<td id="white-rows">SanDisk</td>
                                            </tr>
                                            <tr>
                                    		<td id="rows">Type</td>
                                    		<td id="rows"></td>
                                    		...
                                    		<td id="white-rows">
                                                    <label for="price">&#8377; 379</label>
                                                    <input type="text" name="price" value="379" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td id="textarea" colspan="2" rows="5" cols="50" style="word-wrap: break-word; padding-bottom: 4%;">Description: Ultra-compact and portable USB flash drive. Share your photos, videos, songs and other files between computers with ease. Protect your private files with included SanDisk SecureAccess software. Includes added protection of secure online backup (up to 2GB optionally available) offered by YuuWaa. Password-protect your sensitive files.</td>
                                            </tr>
                            		</table>
                                    </div>
                                    <div style="clear: both;"></div>
