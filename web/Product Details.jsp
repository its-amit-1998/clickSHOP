                ...
                <table>
                    <tr>
                        <td id="details-of-product">
                    		...
                    		<h3>Details of Tata Salt, 1kg</h3><hr><br>
                    		<form action="Product_details.jsp" method="post">  
                            		...
                            		<table id="inner-table">
                                            ...
                                            <tr>
                                                <td id="rows">Name</td>
                                    		<td id="rows">
                                                    <label for="name">Tata Salt</label>
                                                    <input type="text" name="name" value="Tata Salt" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="white-rows">Company</td>
                                    		<td id="white-rows">Tata Chemicals Ltd</td>
                                            </tr>
                                            <tr>
                                    		<td id="rows">Type</td>
                                    		...
                                    		<td id="white-rows">
                                                    <label for="price">&#8377; 18</label>
                                                    <input type="text" name="price" value="18" id="hidden">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td id="textarea" colspan="2" rows="5" cols="50" style="word-wrap: break-word; padding-bottom: 4%;">Description: Vacuum evaporated iodised salt. Lodine helps in mental development of children and prevents iodine deficiency disorders in adults. Tata salt has ventured into new product segments to meet the changing needs of its customers, adding tata salt lite, tata salt plus, sprinklers, tata black salt and tata rock salt to its repertoire.</td>
                                            </tr>
                            		</table>
                                    </div>
                                    <div style="clear: both;"></div>
